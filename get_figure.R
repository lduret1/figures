...
load("cv.Rdata")
load("data_param_N.Rdata")
load("data_param_R_pre.Rdata")
load("data_param_R_post.Rdata")
load("data_param_p_frechet_pre.Rdata")
load("data_param_p_frechet_post.Rdata")
...
hist(data_param_N,xlim=c(1000,40000), breaks=seq(0,40000,2000), ylim=c(0,0.0001),col=rgb(1, 1, 1, alpha=0.5), prob=T, ylab="density", xlab="number of importations")
par(new=TRUE)
...
hist(data_param_R_pre, breaks=seq(2.4,3.4,0.05),xlim=c(2.4,3.4), ylim=c(0,6),col=rgb(1,1,1,alpha=0.5), prob=T, ylab="density", xlab="reproductive number before lockdown")
par(new=TRUE)
...
hist(data_param_R_post, xlim=c(0.5,0.9),breaks=seq(0.5,0.9,0.02),ylim=c(0,11),col=rgb(1,1,1,alpha=0.5),prob=T, ylab="density", xlab="reproductive number after the beginning of lockdown")
par(new=TRUE)
...
hist(data_param_p_frechet_pre, xlim=c(0,1), breaks=seq(0,1,0.1), ylim=c(0,1.7), col=rgb(1,1,1,alpha=0.5),prob=T, ylab="density", xlab="p_frechet_pre")
par(new=TRUE)
...
hist(data_param_p_frechet_post, xlim=c(0,1), breaks=seq(0,1,0.1), ylim=c(0,1.7), col=rgb(1,1,1,alpha=0.5),prob=T, ylab="density", xlab="p_frechet_post")
par(new=TRUE)
